...
import CardTool, { CardToolOnRemove,  CardToolOnRemoved, CardToolOnRefresh } from '../Common/CardTool'
...
class Cards extends Component {
    ...
    onCardRemove: CardToolOnRemove = (card, confirm) => {
    ...
    onCardRemoved: CardToolOnRemoved = () => {
        console.log('Card Removed');
    }

    onCardRefresh: CardToolOnRefresh = (card, done) => {
