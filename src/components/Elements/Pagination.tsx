    ...
    render() {
        return (
            <ul className="pagination justify-content-center">
                {this.props.page !== 1 && (<li className="page-item">
                    <button className="page-link" onClick={this._prevPage}>
                        <span aria-hidden="true">«</span>
                        <span className="sr-only">Previous</span></button>
                </li>)}
                {this.state.pageList}
                {this.state.isShowEndPage && (<li className="page-item">
                    <button className="page-link">&middot;&middot;&middot;</button>
                </li>)}
                {this.state.isShowEndPage && (<li className="page-item">
                    <button className="page-link" onClick={this._goPage}
                            data-page={this.state.totalPage}>{this.state.totalPage}</button>
                </li>)}
                {this.props.page !== this.state.totalPage && (<li className="page-item">
                    <button className="page-link" onClick={this._nextPage}>
                        <span aria-hidden="true">»</span>
